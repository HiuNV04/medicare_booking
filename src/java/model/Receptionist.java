...
public class Receptionist {
    ...
    public Receptionist(String fullname, String gender, String phone, String address, String img) {
    ...
    public Receptionist(int id, String role, String email, String username, String password, String fullname, String dob, String gender, String phone, String address, String img) {
        this.id = id;
        this.role = role;
