...
//        Receptionist r = rdao.getAReceptionistByEmail(username);
        ...
        int totalAppointments = rdao.getTotalAppoinment();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Receptionist current = (Receptionist) request.getSession().getAttribute("receptionist");
            ...
            Receptionist rUpdate = new Receptionist(fullname, gender, phone, address, imageUrl);
