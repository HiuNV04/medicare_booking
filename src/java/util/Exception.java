...
public class Exception {
    ...
    private static SonDAO rdao = new SonDAO();

    public static String getPasswordFormatForPatient(Patient1 p, String oldPass, String password, String cfPass) {
        String msg = "";
    ...
    public static String duplicateCodeError(String identity, String insurance, String phone) {
        ...
        List<Patient1> list = rdao.getListPatient();

        for (Patient1 patient : list) {
