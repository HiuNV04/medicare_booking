...
public class ReAddPatient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String fullname = request.getParameter("fullname").trim().replaceAll("\\s+", " ");
            String dob = request.getParameter("dob");
            String gender = request.getParameter("gender");
            String identity = request.getParameter("identity");
            String insurance = request.getParameter("insurance").toUpperCase();
            ...
            if (error != null) {
                ...
                Patient1 p = new Patient1(role, fullname, dob, gender, identity, insurance, phone, address);
