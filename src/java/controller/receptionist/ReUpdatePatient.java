...
public class ReUpdatePatient extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Patient1 p = pdao.getAPatientById(id);
            if (p == null) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Xử lý ảnh
            Patient1 current = pdao.getAPatientById(id);
            if (current == null) {
                request.setAttribute("error", "Không tìm thấy bệnh nhân với ID: " + id);
                request.getRequestDispatcher("/receptionist/reUpdatePatient.jsp").forward(request, response);
                return;
            ...
            Patient1 pUpdate = new Patient1(id, fullname, gender, dob, identity, insurance, phone, address, imageUrl);
