            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-2">
                    <div class="main-content">
                        ...
                        <form class="row g-2 mb-4 align-items-center" method="get" action="managePatient">
                            <div class="col-md-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-${patient.status ? 'success' : 'secondary'}">
                                                    <c:choose>
                                                        <c:when test="${patient.status}">Hoạt động</c:when>
                                                        <c:otherwise>Đã khóa</c:otherwise>
                                                    </c:choose>
                                                </span>
                                            </td>
                                            <td>
                                                <a href="viewPatientDetail?id=${patient.id}" class="btn btn-sm btn-info text-white">
                            ...
                            <ul class="pagination justify-content-center">
                                <c:forEach var="i" begin="1" end="${totalPage}">
                                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                                        <a class="page-link"
                                           href="managePatient?page=${i}&search=${param.search}&role=${param.role}&status=${param.status}">
                                            ${i}
                                        </a>
                                    </li>
                                </c:forEach>
