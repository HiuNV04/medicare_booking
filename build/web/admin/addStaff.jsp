                                ...
                                <form id="staffForm" action="addStaff" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="mb-3">
                                        <c:if test="${not empty imageUpload}">
                                            <img src="${pageContext.request.contextPath}/${imageUpload}" alt="Preview" style="width:100px;height:100px;border-radius:50%;object-fit:cover;display:block;margin-bottom:6px;">
                                        </c:if>
