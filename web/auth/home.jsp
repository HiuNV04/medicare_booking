<%-- 
    Document   : login
    Created on : May 20, 2025, 2:50:10 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
                ...
                <div class="row justify-content-start">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <div class="pt-2">
                            ...
                            <a href="" class="btn btn-outline-light rounded-pill py-md-3 px-md-5 mx-2">Cuộc hẹn</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                    ...
                    <h1 class="display-4">Dịch vụ y tế tuyệt vời</h1>
                </div>
                <div class="owl-carousel price-carousel position-relative" style="padding: 0 45px 45px 45px;">
                    <div class="bg-light rounded text-center">
                        ...
                        <div class="text-center py-5">
                            ...
                            <p>Bác sĩ có nhiều kinh nghiệm</p>
                            <p>Tỷ lệ thành công cao nhất</p>
                            <p>Dịch vụ điện thoại</p>
                            <a href="" class="btn btn-primary rounded-pill py-3 px-5 my-2">Nộp đơn ngay</a>
                        </div>
                    </div>
                    <div class="bg-light rounded text-center">
                        <div class="position-relative">
                            ...
                            <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
                                <h3 class="text-white">Kiểm tra sức khỏe</h3>
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top fw-normal" style="font-size: 22px; line-height: 45px;">$</small>99<small class="align-bottom fw-normal" style="font-size: 16px; line-height: 40px;">/ Năm</small>
                                </h1>
                            </div>
                        </div>
                        <div class="text-center py-5">
                    ...
                    <div class="bg-light rounded text-center">
                        <div class="position-relative">
                            ...
                            <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
                                <h3 class="text-white">Chăm sóc răng miệng</h3>
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top fw-normal" style="font-size: 22px; line-height: 45px;">$</small>149<small class="align-bottom fw-normal" style="font-size: 16px; line-height: 40px;">/ Năm</small>
                                </h1>
                            </div>
                        </div>
                        <div class="text-center py-5">
                    ...
                    <div class="bg-light rounded text-center">
                        <div class="position-relative">
                            ...
                            <div class="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style="background: rgba(29, 42, 77, .8);">
                                <h3 class="text-white">Vận hành phẫu thuật</h3>
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top fw-normal" style="font-size: 22px; line-height: 45px;">$</small>199<small class="align-bottom fw-normal" style="font-size: 16px; line-height: 40px;">/ Năm</small>
                                </h1>
                            </div>
                        </div>
                        <div class="text-center py-5">
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                    <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Nhận xét</h5>
                    <h1 class="display-4">Bệnh nhân nhận xét dịch vụ của chúng tôi</h1>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="owl-carousel testimonial-carousel">
                            <div class="testimonial-item text-center">
                                ...
                                <h3>Tên bệnh nhân</h3>
                                <h6 class="fw-normal text-primary mb-3">Nghề nghiệp</h6>
                            </div>
                            <div class="testimonial-item text-center">
                                <div class="position-relative mb-5">
